        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="space-y-3 max-w-2xl">
            <div className="flex flex-wrap items-center gap-2.5">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/15 border border-emerald-400/30 text-emerald-300 font-extrabold text-[10px] uppercase tracking-widest shadow-xs">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                Live Dispensary Online
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 border border-white/15 text-slate-300 font-bold text-[10px] tracking-wide backdrop-blur-sm">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight leading-tight">
              Good Morning, <span className="font-serif italic font-normal text-brandOrange-400">Dr. Bharathi</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-1 text-xs">
              <div className="flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-xl backdrop-blur-sm">
                ...
                <span className="text-slate-300 font-medium">Next appointment:</span>
                <span className="text-white font-extrabold">09:30 AM</span>
              </div>
              <div className="flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-xl backdrop-blur-sm">
                <ShoppingBag className="w-3.5 h-3.5 text-emerald-400" />
                <span className="text-slate-300 font-medium">Pending fulfillment:</span>
                <span className="text-white font-extrabold">6 orders</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-wrap items-center gap-3 shrink-0">
            <Link
              to="/admin/products"
              className="inline-flex items-center gap-2.5 px-5 py-3.5 bg-gradient-to-r from-brandOrange-500 via-orange-500 to-amber-500 hover:from-brandOrange-600 hover:to-amber-600 text-white font-black rounded-2xl text-xs sm:text-sm shadow-lg shadow-brandOrange-500/30 hover:shadow-brandOrange-500/50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 border border-white/25 cursor-pointer"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-3.5 bg-white/10 hover:bg-white/15 text-white font-extrabold rounded-2xl text-xs sm:text-sm shadow-sm backdrop-blur-md border border-white/20 hover:border-white/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 cursor-pointer"
            >
            ...
            <Link
              to="/"
              target="_blank"
              className="p-3.5 bg-white/10 hover:bg-white/20 text-slate-200 hover:text-white rounded-2xl transition-all border border-white/15 backdrop-blur-md"
