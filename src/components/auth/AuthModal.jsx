  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto no-scrollbar">
      ...
      >
        ...
        {/* Left Column Spacer (Desktop Only) so Doctor illustration shows on left */}
        <div className="hidden md:block md:w-5/12 min-h-[480px] pointer-events-none" />

        {/* Right Column: Form Panel (Mobile below top banner, Desktop right side) */}
        <div className="w-full md:w-7/12 p-5 sm:p-8 relative flex flex-col justify-between overflow-y-auto no-scrollbar max-h-[88vh] md:max-h-[90vh] bg-[#fdfcf9] md:bg-transparent">
          ...
          {/* Close 'X' Button on Top Right (Desktop Only) */}
          <button
            onClick={closeAuthModal}
